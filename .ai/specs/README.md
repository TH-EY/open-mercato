...
| SPEC | Date | Title | Description |
| --- | --- | --- | --- |
| [Customer Survey Booking Hardening](implemented/2026-07-09-customer-survey-booking-hardening.md) | 2026-07-09 | Customer Survey Booking Hardening | Require explicit Surveyor availability, replace direct staff-table access with a public DI contract, and add persistence/security integration coverage |
