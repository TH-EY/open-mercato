...
The immutable consent registry is pinned to the 2026-08-18 `finoo.pl/apply` bundles (`apply` SHA-256 `44a3f0bbe22918fd891b2a14ba569ef175c86bcc22f5b778456a4d3bb658c7fc`, clauses SHA-256 `9c75fb79458d08c797cccf753ac3c60016a77d5b9042bf15d8f00fa6a08cc7b2`). It deliberately preserves the source bundle's malformed `href` byte-for-byte. Legal/business approval of this exact version, or an approved corrected source version, is required before production consent evidence is treated as authoritative.
