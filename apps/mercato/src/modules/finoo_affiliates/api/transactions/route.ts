  ...
  return NextResponse.json({
    items: transactions.map((transaction) => {
      ...
      return {
        ...
        commissionRateBps: transaction.commissionRateBps ?? null,
        commissionFixedAmount: transaction.commissionFixedAmount ?? null,
        commissionBaseAmount: transaction.commissionBaseAmount ?? null,
...
const itemSchema = z.object({
  ...
  commissionBaseAmount: z.string().nullable(),
  currency: z.string(),
