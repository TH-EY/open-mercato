...
const PORTAL_FEATURES = [
  ...
  { id: 'portal.quotes.accept', labelKey: 'customer_accounts.admin.portalFeatures.quotes.accept', fallback: 'Accept quotes', descriptionKey: 'customer_accounts.admin.portalFeatures.quotes.accept.description', descriptionFallback: 'Allows accepting quotes and converting them to orders' },
