...
/**
 * TC-CRM-073: Person detail clean navigation guard
 *
 ...
 */
test.describe('TC-CRM-073: Person detail clean navigation guard', () => {
  test('leaves an untouched person detail page without an unsaved-changes prompt', async ({ page, request }) => {
    ...
    const displayName = `QA TC-CRM-073 Person ${Date.now()}`;
