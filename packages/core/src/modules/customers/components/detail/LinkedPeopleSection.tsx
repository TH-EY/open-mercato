...
> = {
  ...
  scopeId: string
  /** Optional records already known by the host page, used until the first page load resolves. */
  ...
  /** Bump to force a reload after the host page mutates the links itself. */
  refreshKey?: number
  disabled?: boolean
...
>({
  ...
  const [sortMode, setSortMode] = React.useState<LinkedPeopleSortMode>('name-asc')
                  ...
                  {filtersOpen ? (
                    ...
                    >
                      <option value="name-asc">
                        {translate('customers.linkedPeople.sortNameAsc', 'Sort: Name A-Z')}
                      </option>
                      <option value="name-desc">
                        {translate('customers.linkedPeople.sortNameDesc', 'Sort: Name Z-A')}
                      </option>
                      <option value="recent">
                        {translate('customers.linkedPeople.sortRecent', 'Sort: Recently linked')}
                      </option>
                    </select>
                  ) : null}
                </div>
